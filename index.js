...
app.get('/', (req, res)=>{
    ...
    <p>To create txt file enter, <span style="background-color:yellow;color:blue">/new-create-write-read-txt</span> in the URL</p>
    <p>To Retrieve all txt file enter, <span style="background-color:yellow;color:blue">/read-all-txtFiles</span> in the URL</p>
    </div>
    `);
...
app.get('/read-all-txtFiles', (req, res) => {
    try {
        ...
        All Retrieved Text Files</h1><ul>${txtFiles.map(file => 
